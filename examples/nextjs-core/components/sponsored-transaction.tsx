      ...
      <div className="rounded-xl border border-gray-800 bg-gray-900 p-5">
        ...
        <ol className="mt-3 space-y-2 text-sm text-gray-400">
          <li className="flex gap-2">
            ...
            The JAW instance is configured with a paymaster URL in{" "}
            <code className="text-gray-300">lib/jaw.ts</code>.
          </li>
          <li className="flex gap-2">
          ...
          <li className="flex gap-2">
            ...
            <code className="text-gray-300">wallet_sendCalls</code> as normal.
          </li>
        </ol>
      </div>
    </div>
